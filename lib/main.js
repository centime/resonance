...
(function() {
  var URL, chan, channelsToWorkers, client, currentNick, currentPmUser, data, emitToAllWorkers, irc, list, m, mutedUsers, passEvent, pmUsers, sha1, storage, tabToPreviousPage, tabs, user, widgets, _i, _j, _len, _len1, _ref, _ref1, _ref2, _ref3, _ref4, _ref5,
  ...
  tabs.on('ready', function(tab) {
    var currentTab, i, worker, _base, _ref6, _ref7, _ref8;
    currentTab = -1;
    i = 0;
    while (i < tabs.length) {
      if (tab === tabs[i]) {
