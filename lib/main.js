...
var workers = {
  ...
  'emit':function(a,b,c,d,e,f){
    this._w.forEach(function(w){
        w.port.emit(a,b,c,d,e,f);
    })
  }
} ;

var emit = workers.emit ;
