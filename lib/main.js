...
(function() {
  var URL, channelsToWorkers, client, currentNick, data, irc, mutedUsers, passEvent, sha1, storage, tabToPreviousPage, tabs, widgets, _ref, _ref1;
  ...
  currentNick = (_ref1 = storage.nick) != null ? _ref1 : 'Resonance-dev';
  ...
  tabs.on('ready', function(tab) {
    ...
    return worker.port.on("newMutedUser", function(mutedUsers) {
