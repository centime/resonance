...
(function() {
  var Channel, Tests, URL, activePrivateUsers, chan, client, currentNick, currentPmUser, data, date, emitToAllWorkers, irc, list, m, mutedUsers, passEvent, pmUsers, setTimeout, sha1, storage, tabs, testBot, testChan, testPortReplies, tests, user, widgets, workers, _i, _j, _len, _len1, _ref, _ref1, _ref2, _ref3, _ref4, _ref5,
  ...
  _ref3 = storage.privateMessagesHistory;
  for (user in _ref3) {
    list = _ref3[user];
  ...
  mutedUsers = (_ref4 = storage.mutedUsers) != null ? _ref4 : [];

  currentNick = (_ref5 = storage.nick) != null ? _ref5 : 'Resonance-dev';
  ...
  tabs.on('ready', function(tab) {
    var previousChan, previousWorker, worker, _base, _ref6, _ref7, _ref8;
