...
(function() {
  var Channel, Tests, URL, activePrivateUsers, chan, client, closePage, currentPmUser, data, date, emitToAllWorkers, getChan, irc, list, m, mutedUsers, openPage, panel, passEvent, pmUsers, resonanceOptions, setTimeout, sha1, startClient, storage, tabs, testBot, testChan, testPortReplies, tests, user, workers, _i, _j, _len, _len1, _ref, _ref1, _ref2,
  ...
  getChan = function(url, title) {
    var domain, _ref3, _ref4;

    domain = (_ref3 = url.match(/^(https?\:)\/\/(([^:\/?#]*)(?:\:([0-9]+))?)(\/[^?#]*)(\?[^#]*|)(#.*|)$/)) != null ? (_ref4 = _ref3[2]) != null ? _ref4 : _ref3[2] = '' : void 0;
  ...
  openPage = function(tab) {
    var worker, _base, _ref3, _ref4, _ref5;
    ...
    worker.port.on('say', function(to, message) {
      ...
      if ((_ref6 = (_base1 = storage.messagesHistory)[to]) == null) {
        _base1[to] = [];
      }
      return storage.messagesHistory[to].push({
  ...
  require("sdk/widget").Widget({
    ...
    'onClick': function() {
      ...
      resonanceOptions['domain'] = (_ref3 = tabs.activeTab.url.match(/^(https?\:)\/\/(([^:\/?#]*)(?:\:([0-9]+))?)(\/[^?#]*)(\?[^#]*|)(#.*|)$/)) != null ? (_ref4 = _ref3[2]) != null ? _ref4 : _ref3[2] = '' : void 0;
      resonanceOptions['started'] = (_ref5 = (_base = tabs.activeTab).started) != null ? _ref5 : _base.started = 'false';
  ...
  tabs.on('ready', function(tab) {
    ...
    if (resonanceOptions.activated) {
      domain = (_ref3 = tab.url.match(/^(https?\:)\/\/(([^:\/?#]*)(?:\:([0-9]+))?)(\/[^?#]*)(\?[^#]*|)(#.*|)$/)) != null ? (_ref4 = _ref3[2]) != null ? _ref4 : _ref3[2] = '' : void 0;
  ...
  if (false) {
    ...
    Tests = (function() {
      ...
      Tests.prototype.add = function(test) {
        var prevTest, t, _ref3;

        test.followers = [];
        this.tests.push(test);
        if (!(_ref3 = test.previous, __indexOf.call((function() {
      ...
      Tests.prototype.run = function() {
        var test, _k, _len2, _ref3, _results;

        _ref3 = this.rootTests;
        _results = [];
        for (_k = 0, _len2 = _ref3.length; _k < _len2; _k++) {
          test = _ref3[_k];
      ...
      Tests.prototype.assert = function(test) {
        var assert, next, result, _k, _len2, _ref3, _results;
    ...
    tests.add({
      ...
      'check': function() {
        ...
        return __indexOf.call((function() {
          ...
          _ref3 = storage.messagesHistory[testChan];
          _results = [];
          for (_k = 0, _len2 = _ref3.length; _k < _len2; _k++) {
            e = _ref3[_k];
    ...
    tests.add({
      ...
      'check': function() {
        ...
        if ((_ref3 = (_base = storage.privateMessagesHistory)[testBot]) == null) {
          _base[testBot] = [];
        }
        return __indexOf.call((function() {
          var _k, _len2, _ref4, _results;

          _ref4 = storage.privateMessagesHistory[testBot];
          _results = [];
          for (_k = 0, _len2 = _ref4.length; _k < _len2; _k++) {
            e = _ref4[_k];
            _results.push(e.message);
