...
tabs.on('ready', function(tab) {
  ...
  worker.port.on('getTopPagesKey', function (keyword){
      // Ask the bot for top tapes.
      if (keyword!=null)
        client.say('Resonance-bot','ask keyword '+keyword);
      else
        client.say('Resonance-bot','ask global');
  });
  worker.port.on('getTopPagesDom', function (domain){
      // Ask the bot for top tapes.
      if (domain!='')
        client.say('Resonance-bot','ask domain '+domain);
      else
        client.say('Resonance-bot','ask global');
  });
...
tabs.on('close', function(tab) {
  client.say('Resonance-bot','/leave '+ tab.url);
});
