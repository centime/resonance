...
(function() {
  var Channel, Tests, URL, activePrivateUsers, chan, client, closePage, currentPmUser, data, date, emitToAllWorkers, getChan, irc, list, m, mutedUsers, openPage, panel, passEvent, pmUsers, setTimeout, sha1, startClient, storage, tabs, testBot, testChan, testPortReplies, tests, user, versionResonance, workers, _i, _j, _len, _len1, _ref, _ref1, _ref2, _ref3, _ref4, _ref5,
  ...
  startClient = function(opt) {
    ...
    client.addListener('registered', function(message) {
      ...
      return client.say('Resonance-bot', '__version ' + versionResonance);
    });
    passEvent('names');
    passEvent('join');
    ...
    client.addListener('pm', function(from, message) {
      ...
      if (from === 'Resonance-bot' && message.match(/^announce /)) {
        ...
        return tabs.activeTab.worker.emit('announce', message);
  ...
  getChan = function(url, title) {
    ...
    return '#' + sha1(domain + title.replace(/\ /g, '')).toString();
  };
  ...
  openPage = function(tab) {
    var domain, title, worker, _base, _ref10, _ref6, _ref7, _ref8, _ref9;
    ...
    worker.port.emit('appSize', (_ref8 = storage.appSize) != null ? _ref8 : '100');
    ...
    worker.port.emit('messagesHistory', (_ref9 = storage.messagesHistory[chan]) != null ? _ref9 : []);
    worker.port.emit('pmUsers', pmUsers);
    if ((_ref10 = (_base = storage.privateMessagesHistory)[currentPmUser]) == null) {
      _base[currentPmUser] = [];
    }
    ...
    worker.port.on('say', function(to, message) {
      ...
      if ((_ref11 = (_base1 = storage.messagesHistory)[to]) == null) {
        _base1[to] = [];
      }
      return storage.messagesHistory[to].push({
    ...
    worker.port.on('privateMessage', function(user, message) {
      ...
      if ((_ref11 = (_base1 = storage.privateMessagesHistory)[user]) == null) {
        _base1[user] = [];
      }
    ...
    worker.port.on('getTopPages', function(domain) {
      if (domain !== null && domain !== '') {
        return client.say('Resonance-bot', '__ask keyword ' + domain);
      } else {
        return client.say('Resonance-bot', '__ask global');
      }
    });
